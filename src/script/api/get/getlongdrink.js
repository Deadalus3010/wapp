...
export default class getLongdrink extends React.Component {
 ...
 *****************/
  ...
  *****************/
  ...
  componentDidMount() {
    ...
    fetch("https://waermiapi.platincore.de/api/drinks/longdrink")
  ...
  *****************/
  ...
  renderItem = (data) =>
    <View style={styles.list} >
      <TouchableOpacity style={{ flex: 2.01 }}>
...
module.exports.getLongdrink = getLongdrink;
